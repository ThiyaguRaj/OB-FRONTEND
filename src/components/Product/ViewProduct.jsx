  ...
  render() {
    return (
      <>
        ...
        <Alert onClose={() => { document.getElementById('info').style.visibility="hidden"; }} id="info" severity="info">The table below holds the list of available Plans belongs to Product of ID {this.state.detail.productId}</Alert>
